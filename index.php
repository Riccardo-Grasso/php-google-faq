        ...
        "paragrafi" => [
            ...
            <li class='mb-4'>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
                <ol type='a' class='my-4'>
                    <li class='mb-4'>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
                    <li class='mb-4'>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li>
                </ol>
                </li>
            ...
            "<p class='fs-title-small mt-5'>Stabilire il paese associato al tuo account</p>",
...
<body>
    <header>
        <div class="container-fluid">
            <div class="row-1 d-flex align-items-center justify-content-between">
                <div class="logo d-flex align-items-center">
                    <a href="https://www.google.it/" class="h-100">
                        <img src="img/google_logo.png" alt="logo_google" class="h-100">
                    </a>

                    <span class="fs-22 ">
                        <a href="#" class="privacy text-grey">Privacy e termini</a>
                    </span>
                </div>
                <div class="user d-flex align-items-center h-50">
                    <a href="#">
                        <i class="fas fa-th text-grey"></i>
                    </a>
                    <div class="h-100 ms-4">
                        <img src="img/user-icon-image-placeholder.jpg" class="rounded-circle h-100" alt="user">
                    </div>
                </div>
            </div>
    ...
    <main>
        <div class="container py-5">
            <?php
            foreach ($database as $sectionName => $sections) {
                echo "<div class='$sectionName mb-5 py-3'>";
                foreach ($sections as $elementType => $data) {
                    if ($elementType === "titolo") {
                        echo "<h2 class='mb-5 fs-title-big'>$data</h2>";
                    } elseif ($elementType === "paragrafi") {
                        foreach ($data as $paragraph) {
                            echo "<p class='mb-4 fs-paragraph'>$paragraph</p>";
                        }
                    }
                }
                echo "</div>";
